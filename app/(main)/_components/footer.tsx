...
export default function Footer() {
  ...
  return (
    <motion.div
      ...
      whileInView="animate"
      viewport={{once : true}}
      className="flex flex-col items-center justify-center mt-24 py-20"
    >
      <div className="flex flex-col items-center justify-center">
        <div className="flex flex-col gap-10 items-center justify-center">
          <Logo />
          <h1 className="text-xl text-[#141C3A] dark:text-[#9e9b9b] mt-6 sm:w-[50%] w-[70%] text-center">
            Embracing life's adventures, soaking up wisdom, and rising to new
            challenges with each sunrise.
          </h1>
        </div>
      </div>
